...
function sidebar(prefix=''){return `<aside class="side"><div class="brand"><div class="logo">$</div><div class="brand-text"><span class="brand-title">Contabilidad</span><span class="brand-subtitle">Panel financiero</span></div></div>${nav(prefix)}<div class="auth-mini"><span>${esc(userLabel())}</span><button onclick="logoutContabilidad()">Salir</button></div></aside>`}
